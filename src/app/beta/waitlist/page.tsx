...
export default function BetaWaitlistPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-stone-100 via-stone-50 to-stone-100 dark:from-gray-900 dark:via-background dark:to-gray-900 transition-colors px-4 relative overflow-hidden">
      ...
      {/* Back to Beta Link - Sticky */}
      <div className="fixed top-4 left-4 sm:top-6 sm:left-6 z-50">
        <Link href="/beta" className="text-muted-foreground hover:text-primary transition-colors text-xs sm:text-sm bg-background/90 backdrop-blur border border-border/50 px-3 py-2 rounded-lg shadow-lg hover:shadow-xl hover:bg-background/95">
          ← Back to Beta
        </Link>
      </div>
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <p className="text-primary font-semibold text-lg">
              Coming Q4 2025 - Free Beta Access
            </p>
            <Sparkles className="w-5 h-5 text-primary" />
          </div>
        </div>
