      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {technologies.map((tech, i) => (
              <div key={i} className="text-center group">
                <div className="w-16 h-16 bg-background/50 backdrop-blur border border-border/50 rounded-xl flex items-center justify-center mb-3 mx-auto group-hover:border-primary/50 transition-colors">
                  <span className="text-2xl">{tech.icon}</span>
                </div>
                <div className="text-sm font-medium text-foreground mb-1">{tech.name}</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-green-600 mb-1">Core Engine</div>
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-blue-600 mb-1">UI Platform</div>
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-yellow-600 mb-1">Integrations</div>
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-purple-600 mb-1">Enterprise</div>
        ...
        {/* Beta Benefits */}
        <div className="text-center">
          <div className="inline-flex items-center gap-6 bg-gradient-to-r from-primary/10 to-blue-500/10 px-8 py-6 rounded-2xl">
